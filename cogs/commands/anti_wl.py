...
class Whitelist(commands.Cog):
    ...
    async def whitelist(self, ctx, member: discord.Member = None):
        ...
        if not antinuke or not antinuke[0]:
            embed = discord.Embed(
                ...
                description=(
                    ...
                    "Current Status : <:disabled:1410122359549071400>\n\n"
        ...
        if not member:
            ...
            embed.add_field(name="__**Usage**__", value=f"<a:dot:1410099793983967332> `{prefix}whitelist @user/id`\n<a:dot:1410099793983967332> `{prefix}wl @user`")
            embed.set_thumbnail(url=ctx.bot.user.avatar.url)
            return await ctx.send(embed=embed)
        ...
        if data:
            embed = discord.Embed(title="<:cross:1410121962189095003> Error",
                color=0x000000,
        ...
        embed = discord.Embed(
            ...
            color=0x000000,
            description=(
                f"<:cross:1410121962189095003> : **Ban**\n"
                f"<:cross:1410121962189095003> : **Kick**\n"
                f"<:cross:1410121962189095003> : **Prune**\n"
                f"<:cross:1410121962189095003> : **Bot Add**\n"
                f"<:cross:1410121962189095003> : **Server Update**\n"
                f"<:cross:1410121962189095003> : **Member Update**\n"
                f"<:cross:1410121962189095003> : **Channel Create**\n"
                f"<:cross:1410121962189095003> : **Channel Delete**\n"
                f"<:cross:1410121962189095003> : **Channel Update**\n"
                f"<:cross:1410121962189095003> : **Role Create**\n"
                f"<:cross:1410121962189095003> : **Role Delete**\n"
                f"<:cross:1410121962189095003> : **Role Update**\n"
                f"<:cross:1410121962189095003> : **Mention** @everyone\n"
                f"<:cross:1410121962189095003> : **Webhook Management**"
        ...
        try:
            ...
            if interaction.data["custom_id"] == "catWl":
                ...
                embed = discord.Embed(
                    ...
                    color=0x000000,
                    description=(
                        f"<:tick:1410118593089372242> : **Ban**\n"
                        f"<:tick:1410118593089372242> : **Kick**\n"
                        f"<:tick:1410118593089372242> : **Prune**\n"
                        f"<:tick:1410118593089372242> : **Bot Add**\n"
                        f"<:tick:1410118593089372242> : **Server Update**\n"
                        f"<:tick:1410118593089372242> : **Member Update**\n"
                        f"<:tick:1410118593089372242> : **Channel Create**\n"
                        f"<:tick:1410118593089372242> : **Channel Delete**\n"
                        f"<:tick:1410118593089372242> : **Channel Update**\n"
                        f"<:tick:1410118593089372242> : **Role Create**\n"
                        f"<:tick:1410118593089372242> : **Role Delete**\n"
                        f"<:tick:1410118593089372242> : **Role Update**\n"
                        f"<:tick:1410118593089372242> : **Mention** @everyone\n"
                        f"<:tick:1410118593089372242> : **Webhook Management**"
                ...
                embed_description = "\n".join(f"<:cross:1410121962189095003> : **{name}**" for key, name in fields.items())
                ...
                for value in interaction.data["values"]:
                    ...
                    embed_description = embed_description.replace(f"<:cross:1410121962189095003> : **{fields[value]}**", f"<:tick:1410118593089372242> : **{fields[value]}**")
    ...
    async def whitelistreset(self, ctx):
        ...
        await self.db.commit()
        embed = discord.Embed(title="<:tick:1410118593089372242> Success",
            color=0x000000,
