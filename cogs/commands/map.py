...
class MapView(ui.View):
    ...
    @discord.ui.button(label="", emoji="<:arrow_left:1410112774696206417>", style=ButtonStyle.secondary)
    ...
    @discord.ui.button(label="", emoji="<:arrow_right:1410112731796865095>", style=ButtonStyle.secondary)
