...
class General(commands.Cog):
  ...
  async def membercount(self, ctx: commands.Context):
        ...
        embed.add_field(name="__Count Stats:__",
                        value=f"<:members:1410120717474861106> Total Members: {total_members}\n<:member:1410127604136153088> Total Humans: {total_humans}\n<:robot:1348340531335270420> Total Bots: {total_bots}",
                        inline=False)
  ...
  async def poll(self, ctx: commands.Context, *, message):
    ...
    await msg.add_reaction("<:tick:1410118593089372242>")
    await msg.add_reaction("<:cross:1410121962189095003>")
  ...
  async def users(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      title=f"**<:members:1410120717474861106> CodeX Users**",
  ...
  async def wizz(self, ctx: commands.Context):
    ...
    embed = discord.Embed(
      ...
      description=f"**<:alert:1410119045444927538> Successfully Wizzed {ctx.guild.name}**",
      color=self.color,
  ...
  async def invite(self, ctx: commands.Context):
    embed = discord.Embed(title="CodeX Invite & Support!",
      description=
      f"> <a:dot:1410099793983967332> **[CodeX - Invite Bot](https://dsc.gg/codex-security)**\n> <a:dot:1410099793983967332> **[CodeX - Support](https://discord.gg/pndSM8wrmS)**",
      color=0x000000)
