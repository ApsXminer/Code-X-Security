...
class Fun(commands.Cog):
  ...
  async def mydog(self, ctx, user: discord.User):
      processing= await ctx.reply("<a:loading:1410098840765206659> Processing Image...")
...
############################
  ...
  async def fake_ban(self, ctx, user: discord.Member):
    embed = discord.Embed(
      ...
      description=f"<:tick:1410118593089372242> | {user.mention} has been successfully banned",
      color=0x000000
    )
    embed.set_footer(
