    ...
    async def on_message(self, message):
        ...
        if self.bot.user in message.mentions:
            if len(message.content.strip().split()) == 1:
                ...
                embed.set_footer(text="Powered by Code X Security", icon_url=self.bot.user.avatar.url)

                buttons = [
                    discord.ui.Button(label="Invite", style=discord.ButtonStyle.link, url="https://dsc.gg/codex-security"),
                    discord.ui.Button(label="Web", style=discord.ButtonStyle.link, url="https://codexsecurity.netlify.app//"),
                    discord.ui.Button(label="Support", style=discord.ButtonStyle.link, url="https://discord.gg/pndSM8wrmS"),
                ]
