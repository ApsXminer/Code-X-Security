...
class ReasonModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            await self.user.send(f"<:alert:1410119045444927538> You have been Banned from **{self.author.guild.name}** by **{self.author}**. Reason: {reason or 'No reason provided'}")
            dm_status = "Yes"
...
class Unban(commands.Cog):
    ...
    async def unban(self, ctx, user: discord.User, *, reason=None):
        ...
        embed = discord.Embed(description=f"**<:member:1410127604136153088> Target User:** [{user}](https://discord.com/users/{user.id})\n**<:circle2:1410102626129023017> User Mention:** {user.mention}\n**<a:mail:1410113350636933281> DM Sent:** {dm_status}\n**<:proton:1410107307294986370> Reason:** {reasonn}", color=self.color)
