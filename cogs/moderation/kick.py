...
class Kick(commands.Cog):
    ...
    async def kick_command(self, ctx, member: discord.Member, *, reason: str = None):
        ...
        embed = discord.Embed(
            description=(
                f"**<:member:1410127604136153088> Target User:** [{member}](https://discord.com/users/{member.id})\n"
                f"<:circle2:1410102626129023017> **User Mention:** {member.mention}\n"
                f"<:proton:1410107307294986370> **Reason:** {reason}\n"
