...
class LockUnlockView(ui.View):
    ...
    async def lock(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            description=f"<:tabs:1348326390222557278> **Channel**: {self.channel.mention}\n<:proton:1410107307294986370> **Status**: Locked\n<:arrow_right:1410112731796865095> **Reason:** Lock request by {self.author}",
            color=0x000000
        )
...
class Unlock(commands.Cog):
    ...
    async def unlock_command(self, ctx, channel: discord.TextChannel = None):
        ...
        embed = discord.Embed(
            description=f"<:tabs:1348326390222557278> **Channel**: {channel.mention}\n<:proton:1410107307294986370> **Status**: Unlocked\n<:arrow_right:1410112731796865095> **Reason:** Unlock request by {ctx.author}",
            color=self.color
        )
