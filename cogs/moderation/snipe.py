...
class SnipeView(discord.ui.View):
    ...
    async def send_snipe_embed(self, interaction: discord.Interaction):
        ...
        embed.description = (
            f"<:member:1410127604136153088> **Author:** **[{display_name}](https://discord.com/users/{uid})**\n"
            f"<:location:1348326401505361920> **Author ID:** `{snipe['author_id']}`\n"
            f"<:circle2:1410102626129023017> **Author Mention:** <@{snipe['author_id']}>\n"
    ...
    @discord.ui.button(emoji="<:arrow_left:1410112774696206417>", style=discord.ButtonStyle.secondary, custom_id="previous")
    ...
    @discord.ui.button(emoji="<:arrow_right:1410112731796865095>", style=discord.ButtonStyle.secondary, custom_id="next")
...
class Snipe(commands.Cog):
    ...
    async def snipe(self, ctx):
        ...
        embed.description = (
            ...
            f"<:circle2:1410102626129023017> **Author Mention:** <@{first_snipe['author_id']}>\n"
