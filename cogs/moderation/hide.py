...
class Hide(commands.Cog):
    ...
    async def hide_command(self, ctx, channel: discord.TextChannel = None):
        ...
        embed = discord.Embed(
            description=f"<:tabs:1348326390222557278> **Channel**: {channel.mention}\n<:proton:1410107307294986370> **Status**: Hidden\n<:arrow_right:1410112731796865095> **Reason:** Hide request by {ctx.author}",
            color=self.color
        )
