...
class MuteReasonModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            await self.user.send(f"<:alert:1410119045444927538> You have been muted in **{interaction.guild.name}** for {time_str}. Reason: {reason}")
            dm_status = "Yes"
        except discord.Forbidden:
            dm_status = "No"
        ...
        success_embed = discord.Embed(
            description=f"**<:member:1410127604136153088> Target User:** [{self.user}](https://discord.com/users/{self.user.id})\n<:circle2:1410102626129023017> **User Mention:** {self.user.mention}\n**<:proton:1410107307294986370> Reason:** {reason}\n<a:mail:1410113350636933281> **DM Sent:** {dm_status}", 
...
class Unmute(commands.Cog):
    ...
    async def unmute(self, ctx, user: discord.Member):
        ...
        embed = discord.Embed(
            description=f"**<:member:1410127604136153088> Target User:** [{user}](https://discord.com/users/{user.id})\n**<:circle2:1410102626129023017> User Mention:** {user.mention}\n<a:mail:1410113350636933281> **DM Sent:** {dm_status}",
            color=self.color
        )
